        ...
        {props.content.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-white">Your Brain is Empty</h3>
              <p className="text-slate-400 max-w-md">
                Start building your personal knowledge base by adding your favorite tweets and YouTube videos
              </p>
            </div>
            <Button
